...
function ThemeProvider({
  ...
  return (0, import_jsx_runtime3.jsx)(Provider, {
    value: contextValue,
    children
  });
}
...
function forEach(children, func) {
  ...
  React7.Children.forEach(children, (child) => {
    if (React7.isValidElement(child)) func(child, index++);
  });
}
...
var Transition = (function(_React$Component) {
  ...
  _proto.render = function render() {
    ...
    return (
      ...
      import_react25.default.createElement(TransitionGroupContext_default.Provider, {
        value: null
...
function useMergedRefs(refA, refB) {
  return (0, import_react26.useMemo)(() => mergeRefs(refA, refB), [refA, refB]);
}
...
var TransitionWrapper = import_react27.default.forwardRef(({
  onEnter,
  onEntering,
  onEntered,
  onExit,
  ...
  const handleEnter = (0, import_react27.useCallback)(normalize(onEnter), [onEnter]);
  const handleEntering = (0, import_react27.useCallback)(normalize(onEntering), [onEntering]);
  const handleEntered = (0, import_react27.useCallback)(normalize(onEntered), [onEntered]);
  const handleExit = (0, import_react27.useCallback)(normalize(onExit), [onExit]);
  const handleExiting = (0, import_react27.useCallback)(normalize(onExiting), [onExiting]);
  const handleExited = (0, import_react27.useCallback)(normalize(onExited), [onExited]);
  const handleAddEndListener = (0, import_react27.useCallback)(normalize(addEndListener), [addEndListener]);
  return (0, import_jsx_runtime6.jsx)(Transition_default, {
    ...
    ) : import_react27.default.cloneElement(children, {
      ref: attachRef
    })
  });
});
...
classnames/index.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-53MSVDX5.js.map
