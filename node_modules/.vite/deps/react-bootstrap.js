...
var divWithClassName_default = ((className) => (
  ...
  React11.forwardRef((p, ref) => (0, import_jsx_runtime8.jsx)("div", {
    ...p,
    ref,
...
var Switch = React71.forwardRef((props, ref) => (0, import_jsx_runtime64.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var RTGTransition = React81.forwardRef((_ref, ref) => {
  let {
...
var Modal = (0, import_react44.forwardRef)((_ref, ref) => {
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime76.jsx)("div", Object.assign({}, dialogProps, {
    children: React83.cloneElement(children, {
      role: "document"
    })
  }));
...
var ModalBody = React84.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var ModalContext = React85.createContext({
  onHide() {
  }
});
...
var ModalDialog = React86.forwardRef(({
  bsPrefix,
  className,
  contentClassName,
  centered,
...
var ModalFooter = React87.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var AbstractModalHeader = React88.forwardRef(({
  closeLabel = "Close",
  closeVariant,
  closeButton = false,
  onHide,
...
var ModalHeader = React89.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var ModalTitle = React90.forwardRef(({
  className,
  bsPrefix,
...
var Modal2 = React91.forwardRef(({
  ...
  const renderBackdrop = (0, import_react46.useCallback)((backdropProps) => (0, import_jsx_runtime84.jsx)("div", {
    ...backdropProps,
...
var NavItem2 = React92.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var NavLink = React93.forwardRef(({
  bsPrefix,
  className,
  as: Component2 = Anchor_default,
  active,
...
var Nav2 = React94.forwardRef((uncontrolledProps, ref) => {
  const {
    as = "div",
    bsPrefix: initialBsPrefix,
    variant,
...
var NavbarBrand = React95.forwardRef(({
  bsPrefix,
  className,
  as,
  ...props
...
var NavbarCollapse = React96.forwardRef(({
  children,
  bsPrefix,
  ...props
}, ref) => {
...
var NavbarToggle = React97.forwardRef(({
  bsPrefix,
  className,
  children,
...
var OffcanvasBody = React98.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var OffcanvasToggling = React99.forwardRef(({
  bsPrefix,
  className,
  children,
  in: inProp = false,
  ...
  return (0, import_jsx_runtime92.jsx)(TransitionWrapper_default, {
    ...
    ...props,
    childRef: getChildRef(children),
    children: (status, innerProps) => React99.cloneElement(children, {
      ...innerProps,
...
var OffcanvasHeader = React100.forwardRef(({
  bsPrefix,
  className,
  closeLabel = "Close",
  closeButton = false,
...
var OffcanvasTitle = React101.forwardRef(({
  className,
  bsPrefix,
...
var Offcanvas = React102.forwardRef(({
  bsPrefix,
  className,
  children,
  "aria-labelledby": ariaLabelledby,
  ...
  const renderBackdrop = (0, import_react52.useCallback)((backdropProps) => (0, import_jsx_runtime95.jsx)("div", {
    ...backdropProps,
...
var NavbarOffcanvas = React103.forwardRef(({
  onHide,
  ...props
}, ref) => {
...
var NavbarText = React104.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "span",
  ...props
...
var Navbar = React105.forwardRef((props, ref) => {
  const {
    bsPrefix: initialBsPrefix,
    expand = true,
    variant = "light",
...
var NavDropdown = React106.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React107.forwardRef((props, outerRef) => {
  const {
    flip: flip2,
    offset: offset2,
    placement,
...
var PopoverHeader = React108.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var PopoverBody = React109.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Popover = React111.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style,
...
var Tooltip = React112.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style,
...
var Overlay2 = React113.forwardRef(({
  children: overlay,
  transition = Fade_default,
  popperConfig = {},
  rootClose = false,
  ...
  return (0, import_jsx_runtime109.jsx)(Overlay_default, {
    ...
    children: (overlayProps, {
      ...
      return React113.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper: popper2,
...
var OverlayTrigger = ({
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React114.Children.only(children).props : {};
  const attachRef = (r) => {
  ...
  return (0, import_jsx_runtime112.jsxs)(import_jsx_runtime111.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react59.cloneElement)(children, triggerProps), (0, import_jsx_runtime110.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip: flip2,
...
var PageItem = React115.forwardRef(({
  active = false,
  disabled = false,
  className,
  style,
...
function createButton(name, defaultValue, label = name) {
  const Button2 = React115.forwardRef(({
    children,
    ...props
...
var PlaceholderButton = React117.forwardRef((props, ref) => {
...
var Placeholder = React118.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
var ProgressBar = React119.forwardRef(({
  isChild = false,
  ...rest
}, ref) => {
  const props = {
...
var Ratio = React120.forwardRef(({
  ...
  return (0, import_jsx_runtime119.jsx)("div", {
    ...
    children: React120.Children.only(children)
  });
});
...
var Spinner = React122.forwardRef(({
  bsPrefix,
  variant,
  animation = "border",
  size: size2,
...
var SplitButton = React123.forwardRef(({
  id,
  bsPrefix,
  size: size2,
  variant,
...
var TabPanel = React125.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
...
var ToastFade = React131.forwardRef((props, ref) => (0, import_jsx_runtime133.jsx)(Fade_default, {
  ...props,
  ref,
