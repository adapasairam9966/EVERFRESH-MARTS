...
import "./OrdersHistory.css"; // ⬅️ Added for custom styling
            ...
            <div key={index} className="col-12 col-md-6 col-lg-4">
              <div className="card shadow-sm border-0 rounded-4 h-100 order-card">
                ...
                <div className="card-header bg-white border-0 d-flex justify-content-between align-items-center">
                  <h5 className="mb-0 fw-bold text-primary">Order #{index + 1}</h5>
                ...
                <div className="card-body">
                  {order.items.map((item) => (
                    <div
                      key={item.id}
                      className="d-flex align-items-center mb-3 p-2 order-item"
                      /* ⬅️ Added new class 'order-item' */
                    >
                      <img
                        src={item.image}
                        alt={item.name}
                      ...
                      <div className="flex-grow-1">
                        ...
                        <small className="fw-bold text-success">${item.price.toFixed(2)}</small>
                      </div>
                    </div>
                  ))}
