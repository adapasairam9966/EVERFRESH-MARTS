...
import "./pagination.css"; // 👈 use the same pagination styles
...
function Veg() {
  ...
  return (
    <div className="container my-4">
      <h2 className="mb-4 text-center text-success fw-bold">Vegetables 🥦</h2>
      ...
      <div className="row g-4 mb-4">
        {currentItems.length > 0 ? (
          ...
          <p className="text-center text-muted">
            No vegetables found in this price range.
          </p>
        )}
      </div>
